...
> Release status: `0.8.6` is the latest published release; `0.8.7` is an unreleased source candidate pending native Windows acceptance. See the [changelog](CHANGELOG.md), [compatibility matrix](docs/COMPATIBILITY.md), and [local acceptance record](docs/LOCAL_ACCEPTANCE.md).
