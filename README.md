...
> Release status: `0.8.8` is the latest published release. `0.8.11` is an unreleased source candidate. See the [changelog](CHANGELOG.md), [compatibility matrix](docs/COMPATIBILITY.md), and [local acceptance record](docs/LOCAL_ACCEPTANCE.md).
