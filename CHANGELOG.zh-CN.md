...
- Windows 原生源码验收已通过公开仓库与隐私审计、sibling parity、170 项测试
  ...
  `git diff --check`。
- Codex CLI 0.146.0 隔离安装已通过首次安装、源码/缓存一致性、严格第二次
  no-op、已安装八 Hook 自检和生命周期 smoke。公开 CI/HOL、tag、发布、macOS
  与 fresh trusted-Hook 证据仍是独立阶段，本候选不作声称。
