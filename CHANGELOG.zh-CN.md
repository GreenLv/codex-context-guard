...
- 定向源码回归重放了本次 Stop 决策，并保留中文直接完成声明。macOS 已通过仓库与隐私检查、219 项测试（含 5 项能力性 skip）、八 Hook 自检、Ruff、外部缓存编译和 `git diff --check`。安装、全新可信 Hook、原生 Windows、CI、tag、发布和下游采用仍是独立门禁。
