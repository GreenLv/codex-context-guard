...
- Native Windows installation, trusted-Hook behavior, tag, GitHub Release, downstream consumer-pin evidence, and native-platform reruns beyond macOS remain pending and are not inferred from existing runs. PR #15 at evidence head `38079d5` passes the complete 14-check matrix (Ubuntu/macOS/Windows × Python 3.10–3.13, HOL Plugin Scanner, plugin scanner). Detailed evidence is recorded in `docs/LOCAL_ACCEPTANCE.md`.
