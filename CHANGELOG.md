...
- Native Windows installation, trusted-Hook behavior, tag, GitHub Release, downstream consumer-pin evidence, and native-platform reruns beyond macOS remain pending and are not inferred from existing runs. Detailed evidence is recorded in `docs/LOCAL_ACCEPTANCE.md`.
