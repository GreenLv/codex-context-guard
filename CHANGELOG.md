...
- The prepared source is not yet a clean release commit. Exact-commit CI, the clean-commit macOS portable gate, tags, GitHub Releases, public readback, and the normal runtime upgrade remain unperformed; macOS and Windows remain separate release gates.
