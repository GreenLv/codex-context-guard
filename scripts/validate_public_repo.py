...
VERSION = "0.13.1"
# Stop protocol 4.0 / schema 12 (0.13.1): the public contract pins the runtime
...
REQUIRED_FILES = {
    ...
    "tools/validation/run_selected_validation.py",
    "tools/validation/select_validation.py",
    "tools/validation/validate_workflows.py",
    "tools/validation/verify_required_jobs.py",
