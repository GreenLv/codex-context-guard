...
- `0.13.6` supersedes the unpublished 0.13.5 source candidate. Reply delivery uses a whole-request bounded grammar; unknown tails stay pending, while supported how-to topics do not become execution obligations. State schema, public protocols and Hook events remain unchanged. Fresh runtime/artifact evidence is required; old caches are not rewritten.
