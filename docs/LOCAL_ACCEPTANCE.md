...
independent native macOS and Windows acceptance; exact-main automation remains
pending for the release-document successor. The normal user runtime has not
...
| Exact-main automation | Candidate CI on the exact release-document successor | not performed |
